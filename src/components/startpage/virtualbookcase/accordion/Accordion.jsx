    ...
    <AccordionItem className="accordion_item">
      {({ isActive, onClick }) => (
        <div>
          ...
          Здесь вы можете составлять список книг, которые очень хотели бы почитать, когда у вас найдется свободное время.</p>
          </AccordionItemBody>
        </div>
      )}
    </AccordionItem>
    <AccordionItem className="accordion_item">
      {({ isActive, onClick }) => (
        <div>
          ...
          <AccordionItemBody className="accordion_content">
            <p>Обилие смартфонов, электронных читалок и планшетов сказывается на потере интереса к бумажным книгам. И правда – вместо того, чтобы забивать полки дома или рюкзак в дорогу, 
          гораздо проще скачать десятки книг на небольшое устройство, которое всегда с тобой. Однако у каждого из нас есть те книги, шум страниц которых приносит огромое удовольствиею
